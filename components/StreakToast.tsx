...
export default function StreakToast() {
    ...
    return (
        ...
        <div
            className="fixed inset-x-0 bottom-24 z-[9999] flex justify-center pointer-events-none px-4 sm:bottom-8"
            aria-live="polite"
        >
            <div
                onClick={() => {
            ...
            >
                <div className="relative flex items-center gap-3 px-5 py-3.5 rounded-2xl shadow-2xl overflow-hidden"
                    style={{
                    ...
                    {/* Glow blob */}
                    <div className="absolute -left-4 -top-4 w-20 h-20 rounded-full blur-2xl opacity-40"
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-orange-300/80 text-[12px] font-semibold mt-0.5">
