...
export default function CropModal({
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-0 sm:p-4">
            ...
            <div className="relative bg-white dark:bg-slate-800 sm:rounded-2xl shadow-2xl w-full max-w-3xl h-full sm:h-[70vh] sm:max-h-[90vh] flex flex-col p-4 md:p-6 overflow-hidden pt-[calc(1rem+env(safe-area-inset-top))] pb-10 sm:pb-4">
                <div className="flex-1 bg-slate-100 dark:bg-slate-700 sm:rounded-xl overflow-hidden relative min-h-0 mb-8 sm:mb-0">
                    <Cropper
                        image={imageSrc}
                        crop={crop}
                        zoom={zoom}
