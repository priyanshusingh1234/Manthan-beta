...
import { X, Search, Loader2, Send, Users, CheckCircle2, ArrowLeft, Swords, Zap, MessageSquare, Sparkles } from "lucide-react";
                        ...
                        <div className="flex-1 overflow-y-auto px-3 pb-4 space-y-1 min-h-[200px]">
                            {searchQuery.trim().length < 2 ? (
                                ...
                                <div className="flex flex-col items-center justify-center py-12 text-slate-400 gap-2">
                                    <p className="text-sm font-medium">No users found for &ldquo;{searchQuery}&rdquo;</p>
                                    <p className="text-xs">Try a different name or username</p>
                                </div>
                            ) : (
                                results.map((user) => (
                                    <button
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            {user.avatar ? (
                                                ...
                                                <div className="w-10 h-10 rounded-full bg-indigo-100 text-indigo-600 font-black flex items-center justify-center border border-indigo-200 text-sm">
                    ...
                    <div className="flex flex-col flex-1 p-5 gap-4 overflow-y-auto">
                        ...
                        <div>
                            <div className="flex items-center gap-1.5 mb-2.5">
                                ...
                                <p className="text-xs font-bold text-slate-500 uppercase tracking-wide">Quick messages</p>
                            </div>
