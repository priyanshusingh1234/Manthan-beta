        ...
        <div className="w-full">
            ...
            {modalOpen && (
                <div className="fixed inset-0 z-[999] flex flex-col justify-end sm:justify-center items-center">
                    ...
                    {/* Modal Content */}
                    <div className="relative bg-white dark:bg-slate-900 w-full h-[100dvh] sm:h-auto sm:max-h-[85vh] sm:max-w-md sm:rounded-[2rem] shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom-full sm:zoom-in-95 duration-300">
