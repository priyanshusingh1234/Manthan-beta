const TopperBadge = () => (
  <span className="relative inline-flex items-center justify-center group ml-1" title="Top Performer">
    {/* Animated glow effect */}
    <span className="absolute inset-0 rounded-full bg-amber-400 blur-[2px] opacity-40 group-hover:opacity-100 group-hover:blur-[3px] transition-all duration-300 animate-pulse"></span>
