...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const ogImageUrl = `${BASE_URL}/api/gauntlet/og-image?chapter=${encodeURIComponent(chapter)}&level=1&total=4`;

  return {
    title: `${chapter} — Chapter Gauntlet | Dheeyudha`,
    description: `Battle through 4 levels of in-depth study notes and MCQs on "${chapter}". Earn XP, defeat the boss, and prove your mastery!`,
    openGraph: {
      title: `${chapter} — Chapter Gauntlet`,
      description: 'Earn XP, conquer levels, and defeat the final boss. Can you master this chapter?',
      url: `${BASE_URL}/gauntlet/real-numbers`,
      siteName: 'Dheeyudha',
      images: [
        {
          url: ogImageUrl,
