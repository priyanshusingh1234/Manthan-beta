...
export default function EggDemoPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center text-white gap-6">
            <h1 className="text-2xl font-black">🥚 Daily Egg Drop Preview</h1>
            <p className="text-slate-400 text-sm">Click below to preview the animation</p>
                ...
                {eggDropped && !eggClicked && (
                    <div className="fixed inset-0 z-50 pointer-events-none overflow-hidden">
                        ...
                        >
                            ...
                            />
                            <div className="text-7xl drop-shadow-[0_0_20px_rgba(255,215,0,0.9)] select-none relative z-10">
                                🥚
                            </div>
                            {/* Tap hint */}
                            <motion.div
            ...
            <AnimatePresence>
                {eggClicked && (
                    <motion.div
                        ...
                        className="fixed inset-0 bg-yellow-300 z-[60] flex items-center justify-center text-9xl"
                        onAnimationComplete={() => {}}
                    >
                        💥
                    </motion.div>
