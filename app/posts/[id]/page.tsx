                ...
                <div className="mb-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4">
                    <div className="flex items-center gap-3 mb-2">
                        <Link href={profileUrl}>
                            <div className="w-10 h-10 rounded-full overflow-hidden bg-slate-100 dark:bg-slate-800 relative">
                        ...
                        <div className="min-w-0">
                            <Link href={profileUrl} className="font-bold text-slate-900 dark:text-slate-100 hover:text-indigo-600 truncate block">
