            ...
            <div className="max-w-2xl mx-auto px-4 py-8">
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-muted-foreground text-sm mt-0.5">Review your past attempts and breakdowns</p>
                    </div>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-background rounded-3xl border border-border shadow-sm">
                        ...
                        <h3 className="text-lg font-bold text-foreground mb-1">No questions solved perfectly yet</h3>
                        <p className="text-muted-foreground text-sm max-w-sm mx-auto p-4">When you attempt multiple-choice or written questions, they will appear here along with your AI review breakdown.</p>
                        <button
