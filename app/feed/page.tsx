            ...
            <main className="max-w-[1240px] px-4 sm:px-6 mx-auto relative z-10 w-full lg:flex lg:gap-8 justify-center">
                ...
                <div className="w-full lg:max-w-3xl flex-shrink overflow-x-hidden">
                    ...
                    <div className="mb-6 md:mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
                        <div className="px-1">
                            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-indigo-50/80 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-300 text-[10px] font-black uppercase tracking-widest mb-2 border border-indigo-100/50 dark:border-indigo-800/50">
                            ...
                            <h1 className="text-2xl md:text-5xl font-black tracking-tight text-slate-900 dark:text-white mb-1.5">
                                {feedMeta?.userId ? 'Your Feed' : 'Explore Questions'}
                            </h1>
                            <p className="text-[13px] md:text-base text-slate-500 dark:text-slate-400 font-medium max-w-lg leading-relaxed">
                                {feedMeta?.userId
                        ...
                        {feedMeta?.userId && (
                            <div className="hidden md:flex items-center gap-2 text-xs font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-500/10 px-4 py-2.5 rounded-xl border border-indigo-500/20">
