...
export default function SinglePostPage({ params }: Props) {
    return (
        <Suspense fallback={<View className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 text-slate-500 animate-pulse flex-row">Loading…</View>}>
