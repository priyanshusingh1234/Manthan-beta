    ...
    return new ImageResponse(
        (
            ...
            >
                ...
                {/* Header row */}
                <View style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '48px' }}>
                    <View style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                        ...
                        <Text style={{ color: c.sub, fontSize: '18px', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                            Dheeyudha
                        </Text>
                    </View>
                    <Text style={{ color: c.sub, fontSize: '16px', fontWeight: 600, opacity: 0.7 }}>Weekly Report Card</Text>
                </View>

                {/* Main content row */}
                <View style={{ display: 'flex', flex: 1, alignItems: 'center', gap: '60px' }}>
                    {/* Left: Rating */}
                    <View style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        <View style={{ fontSize: '72px', fontWeight: 900, color: c.text, lineHeight: 1 }}>
                            {emoji} {rating}
                        </View>
                        <View style={{ fontSize: '22px', color: c.sub, fontWeight: 500, opacity: 0.9 }}>
                        ...
                        {subject && (
                            <View style={{
                                ...
                                <Text style={{ color: c.sub, fontSize: '18px', fontWeight: 700 }}>📚 {subject}</Text>
                            </View>
                        )}
                    </View>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '24px' }}>
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <Text style={{ color: c.text, fontSize: '36px', fontWeight: 900, lineHeight: 1 }}>{score}</Text>
                                <Text style={{ color: c.sub, fontSize: '12px', fontWeight: 700, letterSpacing: '0.1em' }}>/100</Text>
                            </View>
                        </View>
                        ...
                        <View style={{ display: 'flex', gap: '16px' }}>
                            {[
                                ...
                                <View key={label} style={{
                                    ...
                                    <Text style={{ color: c.text, fontSize: '24px', fontWeight: 900 }}>{val}</Text>
                                    <Text style={{ color: c.sub, fontSize: '12px', fontWeight: 600, opacity: 0.8, textTransform: 'uppercase' }}>{label}</Text>
                                </View>
                            ))}
                        </View>
                    </View>
                ...
                <View style={{
                    ...
                    <Text style={{ color: c.sub, fontSize: '14px', opacity: 0.6 }}>#Dheeyudha  #WeeklyReport  #StudyGoals</Text>
                    <Text style={{ color: c.sub, fontSize: '14px', fontWeight: 700, opacity: 0.6 }}>dheeyudha.app</Text>
                </View>
            </View>
        ),
