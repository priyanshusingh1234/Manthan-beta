            ...
            {showContent && (
              ...
              >
                ...
                >
                  ...
                  <View style={{ fontSize: 26, fontWeight: 900, color: '#fff', letterSpacing: '-0.03em', lineHeight: 1.1, marginBottom: 10 }}>
                    {info?.title}
                  </View>
                  <View style={{ fontSize: 14, color: 'rgba(255,255,255,0.6)', fontWeight: 600, maxWidth: 260, margin: '0 auto', lineHeight: 1.5 }}>
                    {info?.subtitle}
                  </View>
                </View>
