    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Old → New badges */}
          <View style={{ display: 'flex', alignItems: 'center', gap: 20, marginBottom: 28 }}>
            <View
            ...
            >
              ...
              <Text style={{ color: 'rgba(255,255,255,0.4)', fontSize: 11, fontWeight: 700 }}>{oldLeagueName}</Text>
            </View>
            ...
            >
              ...
              <Text style={{ color: '#fff', fontSize: 13, fontWeight: 900, letterSpacing: 1 }}>{newLeagueName}</Text>
            </View>
          </View>
          ...
          >
            <View style={{ fontSize: 30, fontWeight: 900, color: '#fff', letterSpacing: '-1px', lineHeight: 1.1 }}>
              You've reached
            </View>
            <View style={{ fontSize: 34, fontWeight: 900, color, letterSpacing: '-1px' }}>
              {newLeagueName} League!
            </View>
            <View style={{ color: 'rgba(255,255,255,0.5)', fontSize: 13, fontWeight: 600, marginTop: 8 }}>
