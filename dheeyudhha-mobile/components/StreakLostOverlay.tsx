...
import { Flame, Zap, RotateCcw, X } from 'lucide-react-native';
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Content */}
          <View style={{ padding: '40px 28px 32px', textAlign: 'center', position: 'relative', zIndex: 2 }}>

            {/* Cracked flame icon */}
            <View className="fade-up-1" style={{ marginBottom: 20, display: 'inline-block', position: 'relative' }}>
              {/* Outer glow ring */}
              <View style={{
            ...
            {/* Title */}
            <View className="fade-up-2" style={{ marginBottom: 8 }}>
              <View style={{
            ...
            {/* Body */}
            <View className="fade-up-3" style={{
            ...
            <View className="fade-up-3" style={{
              ...
              <View style={{
                ...
                <View style={{ fontSize: 24, fontWeight: 900, color: '#ef4444' }}>{lostStreak}</View>
                <View style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)', fontWeight: 700, marginTop: 2 }}>Days lost</View>
              </View>
              <View style={{
                flex: 1, background: 'rgba(249,115,22,0.1)', borderRadius: 16,
                padding: '14px 12px', border: '1px solid rgba(249,115,22,0.2)',
              }}>
                <View style={{ fontSize: 24, fontWeight: 900, color: '#f97316' }}>0</View>
                <View style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)', fontWeight: 700, marginTop: 2 }}>Current streak</View>
              </View>
              <View style={{
                flex: 1, background: 'rgba(234,179,8,0.1)', borderRadius: 16,
                padding: '14px 12px', border: '1px solid rgba(234,179,8,0.2)',
              }}>
                <View style={{ fontSize: 24, fontWeight: 900, color: '#eab308' }}>2</View>
                <View style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)', fontWeight: 700, marginTop: 2 }}>To rebuild</View>
              </View>
            </View>

            {/* CTA Buttons */}
            <View className="fade-up-4" style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <View
                onPress={solveNow}
                style={{
              ...
              <View
                onPress={() => { close(); setTimeout(() => router.push('/store'), 500); }}
                style={{
