            ...
            <div className="flex flex-col sm:flex-row sm:items-start gap-6 sm:gap-8">
              ...
              <div className="mt-8 sm:mt-0 perspective-1000 shrink-0">
                <div className="relative group perspective-1000">
                  <div className="absolute -inset-1 bg-gradient-to-r from-amber-400 via-orange-500 to-rose-500 rounded-3xl blur-sm opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200"></div>
                  <div className="relative bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700 text-white px-8 py-6 rounded-3xl shadow-xl text-center min-w-[200px] transform transition-transform group-hover:-translate-y-1">
                    <div className="text-xs font-bold uppercase tracking-widest text-amber-400 mb-2">Global Match</div>
                    <div className="w-8 h-1 bg-gradient-to-r from-amber-400 to-orange-500 mx-auto rounded-full mb-4"></div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-sm p-8 border border-slate-100 dark:border-slate-800 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-4 mb-8">
              <div className="p-3.5 bg-purple-50 dark:bg-purple-900/40 rounded-2xl border border-purple-100 dark:border-purple-800 shadow-inner group-hover:scale-110 transition-transform">
                <Sword className="w-6 h-6 text-purple-600 dark:text-purple-400 drop-shadow-sm" />
              </div>
              <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white tracking-tight">Recent Battles</h2>
            </div>
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-gradient-to-br from-slate-800 to-slate-900 rounded-full flex items-center justify-center text-white font-black text-lg shadow-inner group-hover/battle:scale-105 transition-transform">
                        {battle.opponent.charAt(0)}
                      </div>
                      <div>
                        <h3 className="font-bold text-lg text-slate-900 dark:text-white group-hover/battle:text-purple-600 transition-colors">{battle.opponent}</h3>
                        <p className="text-sm font-medium text-slate-500 dark:text-slate-400">{battle.subject}</p>
                      </div>
                    </div>
                    <div
                      className={`px-4 py-1.5 rounded-full text-sm font-black tracking-wide uppercase ${battle.result === 'Won'
                        ? 'bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 border border-emerald-200/50'
                        : 'bg-rose-100 dark:bg-rose-900/40 text-rose-700 dark:text-rose-400 border border-rose-200/50'
                        }`}
                    >
                      {battle.result}
                    </div>
                  </div>
                  <div className="flex items-center justify-between text-sm font-bold text-slate-400 dark:text-slate-500 pt-3 border-t border-slate-50 dark:border-slate-800/50">
                    <span className="text-slate-700 dark:text-slate-300 bg-slate-50 dark:bg-slate-800 px-3 py-1 rounded-lg">Score: {battle.score}</span>
